...
func _on_start_pressed():
	Audio.stopBGNoise()
	get_tree().change_scene_to_file("res://Scenes/exercise_two.tscn")
...
func _on_description_text_pressed():
	...
	TextToSpeech.playText(" Let’s practice hearing and differentiating between similar-sounding words in sentences!")
